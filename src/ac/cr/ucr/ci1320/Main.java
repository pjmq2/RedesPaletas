...
public class Main {
    ...
    public static Nodo sebastian(){
        ...
        TablaDirecciones tabla7 = new TablaDirecciones("Paletas","12.0.0.8",0,9999, 0000); //200.5.0.1
        ...
        try {
            ...
            tablaIP=getIPtable(fake1, "0", fake2, IP, fake3, IP, fake4, "0"); // La última es la real de Alonso
