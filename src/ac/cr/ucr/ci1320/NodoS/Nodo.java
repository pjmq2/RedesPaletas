...
public class Nodo {
    ...
    public Nodo(HashMap<String, TablaDirecciones> tablaD, String miIp, int miPuerto, HashMap<String,String>tablaIP, String fake1, String fake2, String fake3, String fake4, String fake5) {
        this.tablaD = tablaD;
        this.miIp = miIp;
    ...
    public void changeWish(String newWish)
    {
        this.wishedFaker = newWish;
    }
